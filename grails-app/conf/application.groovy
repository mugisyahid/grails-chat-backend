...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'com.ismachat.User'
grails.plugin.springsecurity.userLookup.authorityJoinClassName = 'com.ismachat.UserRole'
grails.plugin.springsecurity.authority.className = 'com.ismachat.Role'
